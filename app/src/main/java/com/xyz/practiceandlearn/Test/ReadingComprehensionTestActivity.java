...
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_ID_READING_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_ID_READING_SCRIPT;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_ID_READING_SCRIPT_TEST;
import static com.xyz.practiceandlearn.Main.Global.BaseDir;

import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_ANSWER_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_A_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_B_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_C_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_D_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_SCRIPT_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.READINGCOMPREHENSION_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.READINGCOMPREHENSION_SCRIPT_TEST;


public class ReadingComprehensionTestActivity extends AppCompatActivity {

    private String sql_ver1 = COLUMN_ID_READING_SCRIPT_TEST + "<=16 and " + ReadingComprehensionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_READING_QUESTION_TEST + "<=48 and " + ReadingComprehensionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_READING_SCRIPT_TEST + ">=16 and " + ReadingComprehensionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_READING_QUESTION_TEST + ">=48 and " + ReadingComprehensionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "ReadingComprehensionTes";
...
//        objMyDatabase = new MyDatabase(this, photoDB);
    ...
    private String[] listScript(){
        ...
        Cursor objCursor = db.query(READINGCOMPREHENSION_SCRIPT_TEST, new String[]{COLUMN_READING_SCRIPT_TEST},
    ...
    private String[] listQuestion() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION_TEST, new String[]{COLUMN_READING_QUESTION_TEST},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION_TEST, new String[]{COLUMN_READING_ANSWER_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION_TEST, new String[]{COLUMN_READING_CHOICE_A_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION_TEST, new String[]{COLUMN_READING_CHOICE_B_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION_TEST, new String[]{COLUMN_READING_CHOICE_C_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION_TEST, new String[]{COLUMN_READING_CHOICE_D_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
