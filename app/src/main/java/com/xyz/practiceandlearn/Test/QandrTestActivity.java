...
import com.xyz.practiceandlearn.Description.DescriptionShortconActivity;
...
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_ANSWER_TEST;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.QuestionAndResponse_Question_TEST;

public class QandrTestActivity extends AppCompatActivity {

    private  String sql_ver1 = COLUMN_QANDR_ANSWER_TEST + "<=30 and " + QuestionAndResponseDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";

    private  String sql_ver2 = COLUMN_QANDR_ANSWER_TEST + ">=30 and " + QuestionAndResponseDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "QandrTestActivity";
...
//        String filePath = Environment.getExternalStorageDirectory()+"/AudioQandR/"+String.valueOf(Global.currentAnswer+1)+".mp3";
    ...
    private String[] listAnswer(){
        ...
        Cursor objCursor = db.query(QuestionAndResponse_Question_TEST, new String[]{COLUMN_QANDR_ANSWER_TEST},
