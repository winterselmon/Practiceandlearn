...
import com.xyz.practiceandlearn.Description.DescriptionIncompleteActivity;
...
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_ID_SHORTTALK_QUESTION_TEST;
...
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_SHORTTALK_ANSWER_TEST;
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_SHORTTALK_CHOICE_A_TEST;
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_SHORTTALK_CHOICE_B_TEST;
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_SHORTTALK_CHOICE_C_TEST;
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_SHORTTALK_CHOICE_D_TEST;
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.COLUMN_SHORTTALK_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.ShortTalkDatabase.SHORTTALK_QUESTION_TEST;

public class ShortTalkTestActivity extends AppCompatActivity {

    private String sql2_ver1 = COLUMN_ID_SHORTTALK_QUESTION_TEST + "<=30 and " + ShortTalkDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";

    private String sql2_ver2 = COLUMN_ID_SHORTTALK_QUESTION_TEST + ">=30 and " + ShortTalkDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "ShortTalkTestActivity";
    ...
    private void playSound() {
        ...
        if (Version.CURRENT.equals(Version.SECOND)) {
            filepath = new File(basedirPhoto +"/V1/AudioShortTalk_V2/"+String.valueOf(Global.currentposition+1)+".mp3");
...
//        String filePath = basedir +"/V1/AudioShortTalk/"+String.valueOf(Global.currentSound+1)+".mp3";
    ...
    private String[] listQuestion() {
        ...
        Cursor cursor = db.query(SHORTTALK_QUESTION_TEST, new String[]{COLUMN_SHORTTALK_QUESTION_TEST},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(SHORTTALK_QUESTION_TEST, new String[]{COLUMN_SHORTTALK_ANSWER_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null ,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(SHORTTALK_QUESTION_TEST, new String[]{COLUMN_SHORTTALK_CHOICE_A_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(SHORTTALK_QUESTION_TEST, new String[]{COLUMN_SHORTTALK_CHOICE_B_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(SHORTTALK_QUESTION_TEST, new String[]{COLUMN_SHORTTALK_CHOICE_C_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(SHORTTALK_QUESTION_TEST, new String[]{COLUMN_SHORTTALK_CHOICE_D_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
