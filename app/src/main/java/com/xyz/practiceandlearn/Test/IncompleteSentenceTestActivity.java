...
import com.xyz.practiceandlearn.Description.DescriptionTextcomActivity;
...
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_ID_INCOMPLETE_CHOICE_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_ID_INCOMPLETE_QUESTION;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_ID_INCOMPLETE_QUESTION_TEST;
import static com.xyz.practiceandlearn.Main.Global.BaseDir;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_INCOMPLETE_ANSWER_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_INCOMPLETE_CHOICE_A_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_INCOMPLETE_CHOICE_B_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_INCOMPLETE_CHOICE_C_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_INCOMPLETE_CHOICE_D_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.COLUMN_INCOMPLETE_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.INCOMPLETE_CHOICE_TEST;
import static com.xyz.practiceandlearn.Database.IncompleteDatabase.INCOMPLETE_QUESTION_TEST;


public class IncompleteSentenceTestActivity extends AppCompatActivity {

    private String sql_ver1 = COLUMN_ID_INCOMPLETE_QUESTION_TEST + "<=40 and " + IncompleteDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_INCOMPLETE_CHOICE_TEST + "<=40 and " + IncompleteDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_INCOMPLETE_QUESTION_TEST + ">=40 and " + IncompleteDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_INCOMPLETE_CHOICE_TEST + ">=40 and " + IncompleteDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "IncompleteSentenceTestA";
...
//        objMyDatabase = new MyDatabase(this, photoDB);
    ...
    private String[] listQuestion(){
        ...
        Cursor objCursor = db.query(INCOMPLETE_QUESTION_TEST, new String[]{COLUMN_INCOMPLETE_QUESTION_TEST},
    ...
    private String[] listAnswer(){
        ...
        Cursor objCursor = db.query(INCOMPLETE_QUESTION_TEST, new String[]{COLUMN_INCOMPLETE_ANSWER_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql_ver1 : sql_ver2, null, null, null, null);
        objCursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor objCursor = db.query(INCOMPLETE_CHOICE_TEST, new String[]{COLUMN_INCOMPLETE_CHOICE_A_TEST},
    ...
    private String[] listChoiceB() {
        ...
        Cursor objCursor = db.query(INCOMPLETE_CHOICE_TEST, new String[]{COLUMN_INCOMPLETE_CHOICE_B_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        objCursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor objCursor = db.query(INCOMPLETE_CHOICE_TEST, new String[]{COLUMN_INCOMPLETE_CHOICE_C_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        objCursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor objCursor = db.query(INCOMPLETE_CHOICE_TEST, new String[]{COLUMN_INCOMPLETE_CHOICE_D_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        objCursor.moveToFirst();
