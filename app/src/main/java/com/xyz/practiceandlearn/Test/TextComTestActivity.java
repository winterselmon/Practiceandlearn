...
import com.xyz.practiceandlearn.Description.DescriptionReadingActivity;
...
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_ID_TEXTCOM_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_ID_TEXTCOM_SCRIPT;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_ID_TEXTCOM_SCRIPT_TEST;
import static com.xyz.practiceandlearn.Main.Global.BaseDir;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_ANSWER_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_A_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_B_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_C_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_D_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_SCRIPT_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.TEXTCOMPLETION_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.TEXTCOMPLETION_SCRIPT_TEST;


public class TextComTestActivity extends AppCompatActivity {

    private String sql_ver1 = COLUMN_ID_TEXTCOM_SCRIPT_TEST + "<=4 and " + TextCompletionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_TEXTCOM_QUESTION_TEST + "<=12 and " + TextCompletionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_TEXTCOM_SCRIPT_TEST + ">=4 and " + TextCompletionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_TEXTCOM_QUESTION_TEST + ">=12 and " + TextCompletionDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "TextComTestActivity";
...
//        objMyDatabase = new MyDatabase(this, photoDB);
    ...
    private String[] listScript() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_SCRIPT_TEST , new String[]{COLUMN_TEXTCOM_SCRIPT_TEST},
    ...
    private String[] listQuestion() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION_TEST, new String[]{COLUMN_TEXTCOM_QUESTION_TEST},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION_TEST, new String[]{COLUMN_TEXTCOM_ANSWER_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION_TEST, new String[]{COLUMN_TEXTCOM_CHOICE_A_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION_TEST, new String[]{COLUMN_TEXTCOM_CHOICE_B_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION_TEST, new String[]{COLUMN_TEXTCOM_CHOICE_C_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION_TEST, new String[]{COLUMN_TEXTCOM_CHOICE_D_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
