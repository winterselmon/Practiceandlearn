...
import com.xyz.practiceandlearn.Description.DescriptionShortTalkActivity;
...
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_ID_SHORTCONVERSATION_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_ID_SHORTCONVERSATION_SCRIPT;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_ID_SHORTCONVERSATION_SCRIPT_TEST;
...
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_ANSWER_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_A_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_B_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_C_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_D_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_QUESTION_TEST;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.SHORTCONVERSATION_QUESTION_TEST;

public class ShortConTestActivity extends AppCompatActivity {

    private String sql_ver1 = COLUMN_ID_SHORTCONVERSATION_SCRIPT_TEST + "<=10 and " + ShortConDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_SHORTCONVERSATION_QUESTION_TEST + "<=30 and " + ShortConDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_SHORTCONVERSATION_SCRIPT_TEST + ">=10 and " + ShortConDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_SHORTCONVERSATION_QUESTION_TEST + ">=30 and " + ShortConDatabase.COLUMN_VERSION_TEST + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "ShortConTestActivity";
...
//        String filePath = basedir +"/V1/AudioShortCon/"+String.valueOf(Global.currentSound+1)+".mp3";
    ...
    private String[] listQuestion(){
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION_TEST, new String[]{COLUMN_SHORTCONVERSATION_QUESTION_TEST},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION_TEST, new String[]{COLUMN_SHORTCONVERSATION_ANSWER_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null ,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION_TEST, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_A_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION_TEST, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_B_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION_TEST, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_C_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION_TEST, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_D_TEST},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null,null);
        cursor.moveToFirst();
