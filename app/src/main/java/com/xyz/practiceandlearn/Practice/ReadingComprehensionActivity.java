...
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_ID_READING_QUESTION;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_ID_READING_SCRIPT;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_ID_TEXTCOM_QUESTION;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_ID_TEXTCOM_SCRIPT;
import static com.xyz.practiceandlearn.Main.Global.BaseDir;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_ANSWER;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_A;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_B;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_C;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_CHOICE_D;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_DES;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_QUESTION;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.COLUMN_READING_SCRIPT;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.READINGCOMPREHENSION_QUESTION;
import static com.xyz.practiceandlearn.Database.ReadingComprehensionDatabase.READINGCOMPREHENSION_SCRIPT;

public class ReadingComprehensionActivity extends AppCompatActivity {

    private String sql_ver1 = COLUMN_ID_READING_SCRIPT + "<=10 and " + ReadingComprehensionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_READING_QUESTION + "<=30 and " + ReadingComprehensionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_READING_SCRIPT + ">=10 and " + ReadingComprehensionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_READING_QUESTION + ">=30 and " + ReadingComprehensionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "ReadingComprehensionAct";
...
//        objMyDatabase = new MyDatabase(this, photoDB);
    ...
    private String[] listScript(){
        ...
        Cursor objCursor = db.query(READINGCOMPREHENSION_SCRIPT, new String[]{COLUMN_READING_SCRIPT},
    ...
    private String[] listQuestion() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_QUESTION},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_ANSWER},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_CHOICE_A},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_CHOICE_B},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_CHOICE_C},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_CHOICE_D},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceDes() {
        ...
        Cursor cursor = db.query(READINGCOMPREHENSION_QUESTION, new String[]{COLUMN_READING_DES},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
