...
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_ANSWER;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_A;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_B;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_C;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_CHOICE_D;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_DES;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_QUESTION;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.COLUMN_SHORTCONVERSATION_SCRIPT;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.SHORTCONVERSATION_QUESTION;
import static com.xyz.practiceandlearn.Database.ShortConDatabase.SHORTCONVERSATION_SCRIPT;

public class ShortConversationActivity extends AppCompatActivity {

    MyDatabase objMyDatabase;

    private String sql_ver1 = COLUMN_ID_SHORTCONVERSATION_SCRIPT + "<=20 and " + ShortConDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_SHORTCONVERSATION_QUESTION + "<=60 and " + ShortConDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_SHORTCONVERSATION_SCRIPT + ">=20 and " + ShortConDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_SHORTCONVERSATION_QUESTION + ">=60 and " + ShortConDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "ShortConversationActivi";
...
//        objMyDatabase = new MyDatabase(this, photoDB);
    ...
    private void playSound() {
        ...
        if (Version.CURRENT.equals(Version.SECOND)) {
            filepath = new File(basedirPhoto + "/V1/AudioShortConPratice_V2/" + String.valueOf(currentposition + 1) + ".mp3");
...
//        String filePath = basedir+"/V1/AudioShortConPratice/"+String.valueOf(currentposition+1)+".mp3";
    ...
    private String[] listScript() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_SCRIPT, new String[]{COLUMN_SHORTCONVERSATION_SCRIPT},
    ...
    private String[] listQuestion() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_QUESTION},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_ANSWER},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_A},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_B},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_C},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_CHOICE_D},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceDes() {
        ...
        Cursor cursor = db.query(SHORTCONVERSATION_QUESTION, new String[]{COLUMN_SHORTCONVERSATION_DES},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
