...
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_ANSWER;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_A;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_B;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_C;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_CHOICE_D;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_DES;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_QUESTION;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.COLUMN_TEXTCOM_SCRIPT;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.TEXTCOMPLETION_QUESTION;
import static com.xyz.practiceandlearn.Database.TextCompletionDatabase.TEXTCOMPLETION_SCRIPT;


public class TextCompletionActivity extends AppCompatActivity {

    private String sql_ver1 = COLUMN_ID_TEXTCOM_SCRIPT + "<=7 and " + TextCompletionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private String sql2_ver1 = COLUMN_ID_TEXTCOM_QUESTION + "<=21 and " + TextCompletionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";

    private String sql_ver2 = COLUMN_ID_TEXTCOM_SCRIPT + ">=7 and " + TextCompletionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private String sql2_ver2 = COLUMN_ID_TEXTCOM_QUESTION + ">=21 and " + TextCompletionDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    ...
    private static final String TAG = "TextCompletionActivity";
...
//        objMyDatabase = new MyDatabase(this, photoDB);
    ...
    private String[] listScript() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_SCRIPT, new String[]{COLUMN_TEXTCOM_SCRIPT},
    ...
    private String[] listQuestion() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_QUESTION},
    ...
    private String[] listAnswer() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_ANSWER},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_CHOICE_A},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceB() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_CHOICE_B},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_CHOICE_C},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceD() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_CHOICE_D},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
    ...
    private String[] listChoiceDes() {
        ...
        Cursor cursor = db.query(TEXTCOMPLETION_QUESTION, new String[]{COLUMN_TEXTCOM_DES},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        cursor.moveToFirst();
