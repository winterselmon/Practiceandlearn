...
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_ID_QANDR_CHOICE;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_ID_QANDR_QUESTION;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_ANSWER;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_CHOICE_A;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_CHOICE_B;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_CHOICE_C;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_DES;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.COLUMN_QANDR_QUESTION;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.QUESTIONANDRESPONSE_CHOICE;
import static com.xyz.practiceandlearn.Database.QuestionAndResponseDatabase.QuestionAndResponse_Question;
...
public class QandrPracticeActivity extends AppCompatActivity {
    ...
    private  String sql_ver1 = COLUMN_ID_QANDR_CHOICE + "<=30 and " + QuestionAndResponseDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private  String sql2_ver1 = COLUMN_ID_QANDR_QUESTION + "<=30 and " + QuestionAndResponseDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";

    private  String sql_ver2 = COLUMN_ID_QANDR_CHOICE + ">=30 and " + QuestionAndResponseDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";
    private  String sql2_ver2 = COLUMN_ID_QANDR_QUESTION + ">=30 and " + QuestionAndResponseDatabase.COLUMN_VERSION + " = '" + Version.CURRENT +"'";

    private static final String TAG = "QandrPracticeActivity";
...
//                            Toast.makeText(getBaseContext(), "c", Toast.LENGTH_LONG).show();
    ...
    private String[] listQuestion() {
        ...
        Cursor objCursor = db.query(QuestionAndResponse_Question, new String[]{COLUMN_QANDR_QUESTION},
    ...
    private String[] listAnswer() {
        ...
        Cursor objCursor = db.query(QuestionAndResponse_Question, new String[]{COLUMN_QANDR_ANSWER},
                Version.CURRENT.equals(Version.FIRST) ? sql2_ver1 : sql2_ver2, null, null, null, null);
        objCursor.moveToFirst();
    ...
    private String[] listChoiceA() {
        ...
        Cursor objCursor = db.query(QUESTIONANDRESPONSE_CHOICE, new String[]{COLUMN_QANDR_CHOICE_A},
    ...
    private String[] listChoiceB() {
        ...
        Cursor objCursor = db.query(QUESTIONANDRESPONSE_CHOICE, new String[]{COLUMN_QANDR_CHOICE_B},
                Version.CURRENT.equals(Version.FIRST) ? sql_ver1 : sql_ver2, null, null, null, null);
        objCursor.moveToFirst();
    ...
    private String[] listChoiceC() {
        ...
        Cursor objCursor = db.query(QUESTIONANDRESPONSE_CHOICE, new String[]{COLUMN_QANDR_CHOICE_C},
                Version.CURRENT.equals(Version.FIRST) ? sql_ver1 : sql_ver2, null, null, null, null);
        objCursor.moveToFirst();
    ...
    private String[] listChoiceDes() {
        ...
        Cursor objCursor = db.query(QUESTIONANDRESPONSE_CHOICE, new String[]{COLUMN_QANDR_DES},
                Version.CURRENT.equals(Version.FIRST) ? sql_ver1 : sql_ver2, null, null, null, null);
        objCursor.moveToFirst();
